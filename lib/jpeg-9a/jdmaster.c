...
master_selection(j_decompress_ptr cinfo)
{
	...
	const long samplesperrow = (long)cinfo->output_width * (long)cinfo->out_color_components;
	const JDIMENSION jd_samplesperrow = (JDIMENSION)samplesperrow;
	...
	const boolean use_c_buffer = cinfo->inputctl->has_multiple_scans || cinfo->buffered_image;
