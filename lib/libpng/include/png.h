...
#  define png_jmpbuf(png_ptr) \
	...
	PNG_EXPORT(14, void, png_write_chunk, (png_structrp png_ptr, png_const_bytep
		chunk_string, png_const_bytep data, png_size_t length));

	/* Write the start of a PNG chunk - length and chunk name. */
	PNG_EXPORT(15, void, png_write_chunk_start, (png_structrp png_ptr,
		png_const_bytep chunk_string, png_uint_32 length));
	 ...
	 */
	PNG_EXPORTA(19, void, png_info_init_3, (png_infopp ptr_ptr,
...
/* Add an alpha byte to 8-bit Gray or 24-bit RGB images. */
	PNG_EXPORT(40, void, png_set_add_alpha, (png_structrp png_ptr,
		png_uint_32 filler, int filler_loc));
...
#define PNG_GAMMA_THRESHOLD (PNG_GAMMA_THRESHOLD_FIXED*.00001)
	...
	PNG_FP_EXPORT(50, void, png_set_gamma, (png_structrp png_ptr,
		double scrn_gamma, double file_gamma))
...
#define PNG_FILTER_HEURISTIC_LAST       3  /* Not a valid value */
	...
	PNG_EXPORT(98, void, png_free_data, (png_const_structrp png_ptr,
		png_inforp info_ptr, png_uint_32 mask, int num));
...
#  endif
	...
	PNG_FP_EXPORT(133, png_uint_32, png_get_cHRM, (png_const_structrp png_ptr,
		...
		PNG_FIXED_EXPORT(136, void, png_set_cHRM_fixed, (png_const_structrp png_ptr,
			png_inforp info_ptr, png_fixed_point white_x,
		...
		PNG_FIXED_EXPORT(140, void, png_set_gAMA_fixed, (png_const_structrp png_ptr,
			png_inforp info_ptr, png_fixed_point file_gamma))
#endif
	...
	PNG_EXPORT(160, int, png_get_sPLT, (png_const_structrp png_ptr,
		png_inforp info_ptr, png_sPLT_tpp spalettes));
#endif
   ...
   defined(PNG_FLOATING_POINT_SUPPORTED)
	...
	PNG_EXPORT(172, void, png_set_keep_unknown_chunks, (png_structrp png_ptr,
		int keep, png_const_bytep chunk_list, int num_chunks_in));
	...
	PNG_EXPORT(176, int, png_get_unknown_chunks, (png_const_structrp png_ptr,
		png_inforp info_ptr, png_unknown_chunkpp unknowns));
#endif
