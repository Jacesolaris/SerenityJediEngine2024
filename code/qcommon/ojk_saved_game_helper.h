...
namespace ojk
{
	...
	inline const void* SavedGameHelper::get_buffer_data() const
	{
	...
	inline void SavedGameHelper::reset_buffer() const
	{
		saved_game_->reset_buffer();
	}

	inline void SavedGameHelper::reset_buffer_offset() const
	{
		saved_game_->reset_buffer_offset();
	}

	inline void SavedGameHelper::ensure_all_data_read() const
	{
