...
constexpr auto MAX_VEH_WEAPONS = 128; //sigh... no more than 16 different vehicle weapons;
constexpr auto VEH_WEAPON_BASE = 0;
constexpr auto VEH_WEAPON_NONE = -1;
...
#define MAX_VEHICLES	128	//sigh... no more than 64 individual vehicles
...
using vehWeaponStatus_t = struct
{
	//linked firing mode
...
using vehTurretStatus_t = struct
{
	//current weapon ammo
	int ammo;
	//debouncer for ammo recharge
