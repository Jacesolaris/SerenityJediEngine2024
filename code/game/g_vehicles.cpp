...
{
#ifdef _JK2MP
	trap_Trace(results, start, tMins, tMaxs, end, pass_entityNum, contentmask);
#else
	gi.trace(results, start, tMins, tMaxs, end, pass_entityNum, contentmask, static_cast<EG2_Collision>(0), 0);
#endif
}
