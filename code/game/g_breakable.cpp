...
void SP_func_breakable(gentity_t* self)
{
	...
	{
		self->noDamageTeam = static_cast<team_t>(GetIDForString(TeamTable, self->team));
...
constexpr auto MDL_OTHER = 0;
constexpr auto MDL_ARMOR_HEALTH = 1;
constexpr auto MDL_AMMO = 2;
...
constexpr auto MIN_PLAYER_DIST = 1600;
