...
using thinkFunc_t = enum
{
	...
	thinkF_Weapon_HookThink,
	thinkF_Weapon_StunThink,
...
extern void fx_runner_link(gentity_t* ent);
extern void fx_runner_think(gentity_t* ent);
extern void fx_rain_think(gentity_t* ent);
extern void set_MiscAnim(gentity_t* ent);
extern void removeBoltSurface(gentity_t* ent);
...
extern void DEMP2_AltRadiusDamage(gentity_t* ent);
...
extern void Weapon_StunThink(gentity_t* ent);
extern void Weapon_HookFree(gentity_t* ent);
extern void Weapon_StunFree(gentity_t* ent);
...
using clThinkFunc_t = enum
{
	...
	clThinkF_CG_Limb,
	clThinkF_CG_StasisEffect,
};

// CEntity THINK functions...
//
extern void CG_DLightThink(const centity_t* cent);
extern void CG_MatrixEffect(const centity_t* cent);
extern void CG_Limb(const centity_t* cent);
extern void CG_StasisEffect(const centity_t* cent);

//	void		(*reached)(gentity_t *self);	// movers call this when hitting endpoint
using reachedFunc_t = enum
{
	reachedF_NULL = 0,
	//
...
extern void NPC_Pain(gentity_t* self, gentity_t* inflictor, gentity_t* other, const vec3_t point, int damage,
	int mod, int hit_loc = HL_NONE);
extern void station_pain(gentity_t* self, gentity_t* inflictor, gentity_t* other, const vec3_t point, int damage,
	int mod, int hit_loc = HL_NONE);
extern void func_usable_pain(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, const vec3_t point, int damage,
	int mod, int hit_loc = HL_NONE);
extern void NPC_ATST_Pain(gentity_t* self, gentity_t* inflictor, gentity_t* other, const vec3_t point, int damage,
	int mod, int hit_loc = HL_NONE);
...
extern void NPC_Jedi_Pain(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, const vec3_t point, int damage,
	int mod, int hit_loc = HL_NONE);
extern void NPC_Droid_Pain(gentity_t* self, gentity_t* inflictor, gentity_t* other, const vec3_t point, int damage,
	int mod, int hit_loc = HL_NONE);
...
extern void CrystalCratePain(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, const vec3_t point, int damage,
	int mod, int hit_loc = HL_NONE);
extern void TurretPain(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, const vec3_t point, int damage,
	int mod, int hit_loc = HL_NONE);
extern void eweb_pain(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, const vec3_t point, int damage,
	int mod, int hit_loc = HL_NONE);
extern void npc_droideka_pain(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, const vec3_t point,
	int damage, int mod, int hit_loc = HL_NONE);

//	void		(*die)(gentity_t *self, gentity_t *inflictor, gentity_t *attacker, int damage, int mod);
using dieFunc_t = enum
{
	dieF_NULL = 0,
	//
	dieF_funcBBrushDie,
...
extern void funcGlassDie(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int mod,
	int d_flags = 0, int hit_loc = HL_NONE);
extern void laserTrapDelayedExplode(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int mod,
	int d_flags = 0, int hit_loc = HL_NONE);
extern void emplaced_gun_die(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int mod,
	int d_flags = 0, int hit_loc = HL_NONE);
extern void WP_ExplosiveDie(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int meansOfDeath,
	int d_flags = 0, int hit_loc = HL_NONE);
extern void ion_cannon_die(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int mod,
	int d_flags = 0, int hit_loc = HL_NONE);
extern void maglock_die(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int mod, int d_flags = 0,
	int hit_loc = HL_NONE);
extern void camera_die(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int mod, int d_flags = 0,
	int hit_loc = HL_NONE);
extern void Mark1_die(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int mod, int d_flags = 0,
	int hit_loc = HL_NONE);
...
extern void misc_panel_turret_die(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int mod,
	int d_flags = 0, int hit_loc = HL_NONE);
extern void thermal_die(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int mod, int d_flags = 0,
	int hit_loc = HL_NONE);
extern void eweb_die(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int mod, int d_flags = 0,
	int hit_loc = HL_NONE);
...
void GEntity_PainFunc(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, const vec3_t point, int damage,
	int mod, int hit_loc = HL_NONE);
void GEntity_DieFunc(gentity_t* self, gentity_t* inflictor, gentity_t* attacker, int damage, int mod, int d_flags = 0,
	int hit_loc = HL_NONE);
