...
#define	GAMEVERSION	"SerenityJediEngine2024"
...
void G_SetBoltSurfaceRemoval(int ent_num, int model_index, int bolt_index, int surfaceIndex = -1, float duration = 5000);
/*
Ghoul2 Insert End
*/
