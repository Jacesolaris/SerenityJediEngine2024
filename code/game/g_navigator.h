...
constexpr auto USENEWNAVSYSTEM = 1;
...
namespace NAV
{
	using TNodeHandle = int;
	using TEdgeHandle = int;
	...
	////////////////////////////////////////////////////////////////////////////////////
	void show_debug_info(const vec3_t& player_position, int player_waypoint);
	void ShowStats();
...
namespace STEER
{
	...
	////////////////////////////////////////////////////////////////////////////////////
	float Seek(gentity_t* actor, const CVec3& pos, float slowingDistance = 0.0f, float weight = 1.0f,
	...
	float Persue(gentity_t* actor, gentity_t* target, float slowingDistance, float offsetForward,
	...
	// away from them.
	////////////////////////////////////////////////////////////////////////////////////
	float AvoidCollisions(gentity_t* actor, gentity_t* leader = nullptr);
