...
extern void WP_SaberLoadParms2();
...
void G_InitCvars()
{
	...
	else if (com_outcast->integer == 2) //playing mods
	{
		g_char_model = gi.cvar("g_char_model", "jedi_hm", CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART);
	}
	...
	else if (com_outcast->integer == 4) //playing eoc
	{
		g_char_model = gi.cvar("g_char_model", "kyle", CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART);
	}
	else if (com_outcast->integer == 5) //playing eoc
	{
		g_char_model = gi.cvar("g_char_model", "jedi_hm", CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART);
	}
	else if (com_outcast->integer == 6) //playing eoc
	{
		g_char_model = gi.cvar("g_char_model", "jedi_hm", CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART);
	}
	else if (com_outcast->integer == 7) //playing outcast
	{
		g_char_model = gi.cvar("g_char_model", "kyle", CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART);
	}
	else if (com_outcast->integer == 8) //playing outcast
	{
		g_char_model = gi.cvar("g_char_model", "kyle", CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART);
	}
	else if (com_outcast->integer == 9) //playing outcast
	{
		g_char_model = gi.cvar("g_char_model", "jedi_hm", CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART);
	}
	else if (com_outcast->integer == 10) //playing outcast
	{
		g_char_model = gi.cvar("g_char_model", "jedi_hm", CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART);
	}
	else
	...
	const SavedGameJustLoaded_e e_saved_game_just_loaded, const qboolean qb_load_transition)
{
	...
	else if (com_outcast->integer == 2) //mods version
	{
		WP_SaberLoadParms();
	}
	...
	else if (com_outcast->integer == 7)
	{
		WP_SaberLoadParms(); //outcast version
	}
	else if (com_outcast->integer == 8)
	{
		WP_SaberLoadParms(); //outcast version
	}
	else if (com_outcast->integer == 9)
	{
		WP_SaberLoadParms(); //outcast version
	}
	else if (com_outcast->integer == 10)
	{
		WP_SaberLoadParms();
	}
	else
...
extern "C" Q_EXPORT game_export_t * QDECL GetGameAPI(const game_import_t * import)
{
	...
	globals.ClientUserinfoChanged = client_userinfo_changed;
