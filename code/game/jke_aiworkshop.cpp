...
extern qboolean Q3_SetAnimUpper(int ent_id, const char* anim_name);
extern qboolean Q3_SetAnimLower(int ent_id, const char* anim_name);
extern void Q3_SetAnimHoldTime(int ent_id, int int_data, qboolean lower);
...
extern void Q3_SetHealth(int ent_id, int data);
...
extern void Q3_SetArmor(int ent_id, int data);
...
// Set NPC gravity
extern void Q3_SetGravity(int ent_id, float float_data);
...
// Set NPC scale
extern void Q3_SetScale(int ent_id, float float_data);
