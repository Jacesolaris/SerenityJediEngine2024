...
#define VERSION_INTERNAL_BUILD		16

#define VERSION_STRING				"Year-23,Month-12,Day-16,BuildNum-07"
#define VERSION_STRING_DOTTED		"Year-23,Month-12,Day-16,BuildNum-07" // build date
