...
#define VERSION_INTERNAL_BUILD		24

#define VERSION_STRING				"Year-23,Month-10,Day-24,BuildNum-16"
#define VERSION_STRING_DOTTED		"Year-23,Month-10,Day-24,BuildNum-16" // build date
