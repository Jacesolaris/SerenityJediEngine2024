...
#define VERSION_INTERNAL_BUILD		15

#define VERSION_STRING				"Year-23,Month-08,Day-15,BuildNum-12"
#define VERSION_STRING_DOTTED		"Year-23,Month-08,Day-15,BuildNum-12" // build date
