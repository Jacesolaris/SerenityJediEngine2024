...
#define VERSION_INTERNAL_BUILD		14

#define VERSION_STRING				"Year-23,Month-08,Day-14,BuildNum-11"
#define VERSION_STRING_DOTTED		"Year-23,Month-08,Day-14,BuildNum-11" // build date
