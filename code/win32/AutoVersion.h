...
#define VERSION_INTERNAL_BUILD		31

#define VERSION_STRING				"Year-23,Month-07,Day-31,BuildNum-24"
#define VERSION_STRING_DOTTED		"Year-23,Month-07,Day-31,BuildNum-24" // build date
