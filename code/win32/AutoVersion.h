...
#define VERSION_INTERNAL_BUILD		17

#define VERSION_STRING				"Year-23,Month-08,Day-17,BuildNum-14"
#define VERSION_STRING_DOTTED		"Year-23,Month-08,Day-17,BuildNum-14" // build date
