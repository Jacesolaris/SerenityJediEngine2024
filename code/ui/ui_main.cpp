...
static qboolean UI_RunMenuScript(const char** args)
{
	...
	if (String_Parse(args, &name))
	{
		...
		else if (Q_stricmp(name, "closeingame1") == 0)
		{
			trap_Key_SetCatcher(trap_Key_GetCatcher() & ~KEYCATCH_UI);
			trap_Key_ClearStates();
			Cvar_Set("cl_paused", "0");
		...
		else if (Q_stricmp(name, "closeingame2") == 0)
		{
			trap_Key_SetCatcher(trap_Key_GetCatcher() & ~KEYCATCH_UI);
			trap_Key_ClearStates();
			Cvar_Set("cl_paused", "0");
...
static void UI_BuildPlayerModel_List(const qboolean inGameLoad)
{
	...
	for (int i = 0; i < numdirs; i++, dirptr += dirlen + 1)
	{
		...
		{
			Com_sprintf(fpath, sizeof fpath, "models/players/%s/PlayerChoiceyav.txt", dirptr); //yavIV version
		}
		else if (ui_com_outcast.integer == 4)
		{
			Com_sprintf(fpath, sizeof fpath, "models/players/%s/PlayerChoicekotor.txt", dirptr); //eoc version
		}
		...
		{
			Com_sprintf(fpath, sizeof fpath, "models/players/%s/PlayerChoice.txt", dirptr); //eoc version
		}
		...
		else if (ui_com_outcast.integer == 9)
		{
			Com_sprintf(fpath, sizeof fpath, "models/players/%s/PlayerChoice.txt", dirptr); //outcast version
		}
		else if (ui_com_outcast.integer == 10)
		{
			Com_sprintf(fpath, sizeof fpath, "models/players/%s/PlayerChoice.txt", dirptr); //outcast version
		}
		else
...
void _UI_Init(const qboolean inGameLoad)
{
	...
	if (inGameLoad)
	{
		...
		{
			UI_LoadMenus("ui/ingame1.txt", qtrue); //outcast version
		}
		else if (ui_com_outcast.integer == 2)
		{
			UI_LoadMenus("ui/ingame2.txt", qtrue); //mod version
		}
		else if (ui_com_outcast.integer == 3)
		{
			UI_LoadMenus("ui/ingame3.txt", qtrue); //yavIV version
		}
		else if (ui_com_outcast.integer == 4)
		{
			UI_LoadMenus("ui/ingame4.txt", qtrue); //eoc version
		}
		else if (ui_com_outcast.integer == 5)
		{
			UI_LoadMenus("ui/ingame4.txt", qtrue); //eoc version
		...
		{
			UI_LoadMenus("ui/ingame.txt", qtrue); //eoc version
		}
		else if (ui_com_outcast.integer == 7)
		{
			UI_LoadMenus("ui/ingame1.txt", qtrue); //outcast version
		...
		{
			UI_LoadMenus("ui/ingame.txt", qtrue); //outcast version
		}
		else if (ui_com_outcast.integer == 10)
		{
			UI_LoadMenus("ui/ingame2.txt", qtrue); //outcast version
		}
		else
		{
...
void UI_Load()
{
	...
	if (uiInfo.inGameLoad)
	{
		...
		{
			menuSet = "ui/ingame1.txt"; //outcast version
		}
		else if (ui_com_outcast.integer == 2)
		{
			menuSet = "ui/ingame2.txt"; //mod version
		}
		else if (ui_com_outcast.integer == 3)
		{
			menuSet = "ui/ingame3.txt"; //yavIV version
		}
		else if (ui_com_outcast.integer == 4)
		{
			menuSet = "ui/ingame4.txt"; //eoc version
		}
		else if (ui_com_outcast.integer == 5)
		{
			menuSet = "ui/ingame4.txt"; //eoc version
		...
		{
			menuSet = "ui/ingame.txt"; //eoc version
		}
		else if (ui_com_outcast.integer == 7)
		{
			menuSet = "ui/ingame1.txt"; //outcast version
		...
		{
			menuSet = "ui/ingame.txt"; //outcast version
		}
		else if (ui_com_outcast.integer == 10)
		{
			menuSet = "ui/ingame2.txt"; //outcast version
		}
		else
		{
...
void UI_InGameMenu(const char* menuID)
{
	...
	else
	{
		...
		{
			Menus_ActivateByName("ingame1MainMenu"); //outcast version
		}
		else if (ui_com_outcast.integer == 2)
		{
			Menus_ActivateByName("ingame2MainMenu"); //mod version
		}
		else if (ui_com_outcast.integer == 3)
		{
			Menus_ActivateByName("ingame3MainMenu"); //yavIV version
		}
		else if (ui_com_outcast.integer == 4)
		{
			Menus_ActivateByName("ingame4MainMenu"); //eoc version
		}
		else if (ui_com_outcast.integer == 5)
		{
			Menus_ActivateByName("ingame4MainMenu"); //eoc version
		...
		{
			Menus_ActivateByName("ingameMainMenu"); //eoc version
		}
		else if (ui_com_outcast.integer == 7)
		{
			Menus_ActivateByName("ingame1MainMenu"); //outcast version
		...
		{
			Menus_ActivateByName("ingameMainMenu"); //outcast version
		}
		else if (ui_com_outcast.integer == 10)
		{
			Menus_ActivateByName("ingame2MainMenu"); //outcast version
		}
		else
		{
...
void UI_InGameMenu1(const char* menuID)
{
#ifdef JK2_MODE
	ui.PrecacheScreenshot();
#endif
...
void UI_InGameMenu2(const char* menuID)
{
#ifdef JK2_MODE
	ui.PrecacheScreenshot();
#endif
...
void UI_InGameMenu3(const char* menuID)
{
#ifdef JK2_MODE
	ui.PrecacheScreenshot();
#endif
...
void UI_InGameMenu4(const char* menuID)
{
#ifdef JK2_MODE
	ui.PrecacheScreenshot();
#endif
...
void UI_ResetDefaults()
{
	...
	ui.Cmd_ExecuteText(EXEC_APPEND, "exec SerenityJediEngine2024-SP-default.cfg\n");
...
void ReadSaveDirectory()
{
	...
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-YAV", ".sav", s_savegame.listBuf, LISTBUFSIZE);
		//mod version
	}
	else if (ui_com_outcast.integer == 4)
	{
	...
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-SECRET", ".sav", s_savegame.listBuf, LISTBUFSIZE);
		//mod version
	}
	else if (ui_com_outcast.integer == 7)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-NOC", ".sav", s_savegame.listBuf, LISTBUFSIZE);
		//mod version
	}
	else if (ui_com_outcast.integer == 8)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-PIB", ".sav", s_savegame.listBuf, LISTBUFSIZE);
		//mod version
	}
	else if (ui_com_outcast.integer == 9)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-RED", ".sav", s_savegame.listBuf, LISTBUFSIZE);
		//mod version
	}
	else if (ui_com_outcast.integer == 10)
	{
		fileCnt = ui.FS_GetFileList("Account/Saved-Missions-MD", ".sav", s_savegame.listBuf, LISTBUFSIZE);
	}
	else
	{
		if (!ui_g_newgameplusJKA.integer)
