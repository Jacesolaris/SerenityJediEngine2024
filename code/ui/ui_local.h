...
extern void UI_InGameMenu1(const char* menuID); //outcast version
extern void UI_InGameMenu2(const char* menuID); //mod version
extern void UI_InGameMenu3(const char* menuID); //yavIV version
extern void UI_InGameMenu4(const char* menuID); //eoc version
