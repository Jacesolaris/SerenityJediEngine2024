...
//rww - RAGDOLL_BEGIN
void G2_Animate_Bone_List(CGhoul2Info_v& ghoul2, int currentTime, int index, CRagDollUpdateParams* params);
//rww - RAGDOLL_END
...
qboolean G2_Set_Bone_Angles_Matrix(CGhoul2Info* ghlInfo, boneInfo_v& blist, const char* boneName, const mdxaBone_t& matrix, const int flags, const int blendTime, const int currentTime);

int G2_Get_Bone_Index(CGhoul2Info* ghoul2, const char* boneName, qboolean b_add_if_not_found);
...
qboolean G2_Get_Bone_Anim_Index(boneInfo_v& blist, const int index, const int currentTime, float* retcurrentFrame, int* startFrame, int* endFrame, int* flags, float* retAnimSpeed, const int numFrames);
...
#ifdef _G2_GORE
void G2_TransformModel(CGhoul2Info_v& ghoul2, const int frame_num, vec3_t scale, CMiniHeap* G2VertSpace, int useLod, const bool ApplyGore, const SSkinGoreData* gore = 0);
#else
void G2_TransformModel(CGhoul2Info_v& ghoul2, const int frame_num, vec3_t scale, CMiniHeap* G2VertSpace, int useLod);
#endif
...
int G2API_InitGhoul2Model(CGhoul2Info_v& ghoul2, const char* fileName, const int modelIndex, const qhandle_t customSkin = NULL_HANDLE, const qhandle_t customShader = NULL_HANDLE, const int modelFlags = 0, const int lodBias = 0);
...
qboolean G2API_SetBoneAnim(CGhoul2Info* ghlInfo, const char* boneName, const int startFrame, const int endFrame, const int flags, const float animSpeed, const int acurrentTime, const float setFrame = -1, const int blendTime = -1);
...
qboolean G2API_SetBoneAngles(CGhoul2Info* ghlInfo, const char* boneName, const vec3_t angles, const int flags, const Eorientations up, const Eorientations left, const Eorientations forward, qhandle_t* modelList, const int blendTime = 0, const int acurrentTime = 0);

qboolean G2API_SetBoneAnglesOffset(CGhoul2Info* ghlInfo, const char* boneName, const vec3_t angles, const int flags, const Eorientations up, const Eorientations left, const Eorientations forward, qhandle_t* modelList, const int blendTime = 0, const int acurrentTime = 0, const vec3_t offset = nullptr);
...
void G2API_CopyGhoul2Instance(const CGhoul2Info_v& g2From, CGhoul2Info_v& g2To, int modelIndex = -1);
...
qboolean G2API_SetBoneAnglesMatrix(CGhoul2Info* ghlInfo, const char* boneName, const mdxaBone_t& matrix, const int flags, qhandle_t* modelList, const int blendTime = 0, const int acurrentTime = 0);
