...
constexpr auto MAX_CAMERA_GROUP_SUBJECTS = 16;
constexpr auto MAX_ACCEL_PER_FRAME = 10.0f;
constexpr auto MAX_SHAKE_INTENSITY = 12.0f;
constexpr auto CAMERA_DEFAULT_FOV = 90.0f;
constexpr auto CAMERA_WIDESCREEN_FOV = 120.0f;
constexpr auto BAR_DURATION = 1000.0f;
constexpr auto BAR_RATIO = 48.0f;
constexpr auto MAX_BLOCKSHAKE_INTENSITY = 8.0f;

constexpr auto CAMERA_MOVING = 0x00000001;
constexpr auto CAMERA_PANNING = 0x00000002;
constexpr auto CAMERA_ZOOMING = 0x00000004;
constexpr auto CAMERA_BAR_FADING = 0x00000008;
constexpr auto CAMERA_FADING = 0x00000010;
constexpr auto CAMERA_FOLLOWING = 0x00000020;
constexpr auto CAMERA_TRACKING = 0x00000040;
constexpr auto CAMERA_ROFFING = 0x00000080;
constexpr auto CAMERA_SMOOTHING = 0x00000100;
constexpr auto CAMERA_CUT = 0x00000200;
constexpr auto CAMERA_ACCEL = 0x00000400;
...
//
using camera_t = struct camera_s
{
