...
public:
	...
	// Initializers
	////////////////////////////////////////////////////////////////////////////////////
	void Set(const CVec4& x, const CVec4& y, const CVec4& z, const CVec4& w)
	{
		v[0] = x;
		v[1] = y;
		v[2] = z;
	...
	////////////////////////////////////////////////////////////////////////////////////
	bool operator==(const CMatrix& t) const
	{
	...
	////////////////////////////////////////////////////////////////////////////////////
	const CMatrix& operator=(const CMatrix& t)
	{
		v[0] = t.v[0];
		v[1] = t.v[1];
		v[2] = t.v[2];
	...
	{
		return CMatrix(v[0] + t.v[0], v[1] + t.v[1], v[2] + t.v[2], v[3] + t.v[3]);
	}
	...
	// Matrix Scale
	////////////////////////////////////////////////////////////////////////////////////
	const CMatrix& operator*=(const float d)
	{
		v[0] *= d;
		v[1] *= d;
		v[2] *= d;
	...
	CMatrix operator*(const CMatrix& t) const
	{
		...
		for (int i = 0; i < 4; i++)
		{
			for (int j = 0; j < 4; j++)
			{
				float Accumulator = 0.0f; // Reset The Accumulator
				for (int k = 0; k < 4; k++)
				{
