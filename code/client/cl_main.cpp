...
void CL_Init()
{
	...
	Com_Printf("---------------------Build date 08/10/2023-----------------------\n");
	Com_Printf("-----------------------------------------------------------------\n");
	...
	cl_newgameplusJKA = Cvar_Get("g_newgameplusJKA", "0", CVAR_ARCHIVE | CVAR_SAVEGAME | CVAR_NORESTART);
