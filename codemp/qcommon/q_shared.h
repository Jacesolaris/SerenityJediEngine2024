...
#define PRODUCT_NAME			"SerenityJediEngine2024-MP"
...
#define OPENJKGAME "SerenityJediEngine2024"

//NOTENOTE: Only change this to re-point ICARUS to a new script directory
#define Q3_SCRIPT_DIR	"mpscripts"
...
#define NET_ADDRSTRMAXLEN 96 // maximum length of an IPv6 address string including trailing '\0'
...
typedef enum
{
	...
	BLOCKED_TOP_PROJ,
	BLOCKED_FRONT_PROJ,
	BLOCKED_BLOCKATTACK_LEFT,
	BLOCKED_BLOCKATTACK_RIGHT,
	BLOCKED_BLOCKATTACK_FRONT,
	BLOCKED_BACK
} saberBlockedType_t;
...
typedef struct playerState_s {
	...
	int     cloakCharcgestartTime;
	int     cloakchargelaststartTime;
...
//New  buttons
#define	BUTTON_GRAPPLE     		4096		//+button12
#define	BUTTON_KICK	            8192		//+button13
#define	BUTTON_BLOCK			16384		//+button14
#define	BUTTON_DASH 			32768       //+button15
#define	BUTTON_BOTUSE     		65536	    //+button16
#define	BUTTON_PRONEUP			131072      //+button17
#define	BUTTON_BOTSABERTHROW	262144      //+button18
#define	BUTTON_PRONEDOWN		524288      //+button19
#define	BUTTON_GLOAT			1048576     //+button20
#define	BUTTON_RESPECT			2097152     //+button21
#define	BUTTON_FLOURISH			4194304     //+button21
#define	BUTTON_THERMALTHROW		8388608		//+button22
...
#define FLAG_SABERLOCK_ATTACKER		6
#define FLAG_FLAMETHROWER	7
#define FLAG_PARRIED		8
#define FLAG_PREBLOCK		9
#define FLAG_BLOCKED		10
#define FLAG_BLOCKING       11
#define FLAG_BLOCKDRAINED   12
#define FLAG_FROZEN			13
#define FLAG_BLOCKEDBOUNCE	14
#define FLAG_WRISTBLASTER	15
#define FLAG_TIMEDBLOCK 	16
...
#define FATIGUE_JUMP			1
#define FATIGUE_SABERBLOCK		1
#define FATIGUE_BOLTBLOCK		1
#define FATIGUE_MELEE			2
#define FATIGUE_SABERATTACK		1
#define FATIGUE_BLOCKED		    1
#define FATIGUE_SABERTRANS		1
#define FATIGUE_BACKBLOCK		2
#define FATIGUE_DUALSABERTRANS	2
#define FATIGUE_BACKFLIP		3
#define FATIGUE_BACKFLIP_ATARU		-FATIGUE_JUMP + 1
#define FATIGUE_AUTOSABERDEFENSE 2
#define FATIGUE_SPECIALMOVE		2
#define FATIGUE_AUTOBOLTBLOCK	2
#define FATIGUEDTHRESHHOLD		.1
#define FATIGUE_KICKHIT			10
...
#define FATIGUE_ATTACKFAKE		2
#define FATIGUE_DODGE   		45
#define FATIGUE_DODGEING   		40
#define FATIGUE_DODGEINGBOT   	70
#define WALKSPEED			1.75
#define FLAMETHROWER_FUELCOST 3
#define FORCE_LONGJUMP_POWER	20
#define FORCE_DEFLECT_PUSH  	10
#define FATIGUE_AUTOSABERBOLTBLOCK	1
#define FATIGUE_BLOCKPOINTDRAIN	5
#define FATIGUE_BP_ABSORB	    2

#define MISHAPLEVEL_OVERLOAD	    16
#define MISHAPLEVEL_MAX			    15
#define MISHAPLEVEL_FULL		    14
#define MISHAPLEVEL_THIRTEEN	    13
#define	MISHAPLEVEL_HUDFLASH        12
#define	MISHAPLEVEL_ELEVEN	        11
#define	MISHAPLEVEL_TEN             10
#define	MISHAPLEVEL_NINE 	        9
#define MISHAPLEVEL_HEAVY		    8
#define MISHAPLEVEL_SEVEN		    7
#define MISHAPLEVEL_SIX 		    6
#define MISHAPLEVEL_LIGHT		    5
#define MISHAPLEVEL_PAIN		    5
#define MISHAPLEVEL_FOUR		    4
#define MISHAPLEVEL_SNIPER		    3
#define MISHAPLEVEL_MAXINACCURACY   5.0f
#define MISHAPLEVEL_RUNINACCURACY   2
#define MISHAPLEVEL_WALKINACCURACY  1.5f
#define MISHAPLEVEL_STANDINACCURACY 1.1
#define MISHAPLEVEL_MININACCURACY   1
#define MISHAPLEVEL_MIN		        1
#define MISHAPLEVEL_NONE		    0

#define BLASTERMISHAPLEVEL_MAX		   30
#define BLASTERMISHAPLEVEL_TWENTYNINE  29
#define BLASTERMISHAPLEVEL_TWENTYEIGHT 28
#define BLASTERMISHAPLEVEL_OVERLOAD	   27
#define BLASTERMISHAPLEVEL_TWENTYSIX   26
#define BLASTERMISHAPLEVEL_FULL		   25
#define BLASTERMISHAPLEVEL_HEAVYER	   20
#define BLASTERMISHAPLEVEL_HALF 	   15
#define BLASTERMISHAPLEVEL_HEAVY	   10
#define BLASTERMISHAPLEVEL_MEDIUM	   7
#define BLASTERMISHAPLEVEL_LIGHT	   5
#define BLASTERMISHAPLEVEL_RUNINACCURACY   3
#define BLASTERMISHAPLEVEL_TWO             2
#define BLASTERMISHAPLEVEL_WALKINACCURACY  1.5
#define BLASTERMISHAPLEVEL_STANDINACCURACY	1.1
#define BLASTERMISHAPLEVEL_MININACCURACY   1
#define BLASTERMISHAPLEVEL_MIN		1
#define BLASTERMISHAPLEVEL_NONE		0

#define	BLOCK_POINTS_MAX            100
#define BLOCKPOINTS_FULL            90
#define BLOCKPOINTS_MISSILE         75
#define BLOCKPOINTS_KNOCKAWAY       65
#define BLOCKPOINTS_HALF            50
#define BLOCKPOINTS_FOURTY          40
#define BLOCKPOINTS_THIRTY          30
#define BLOCKPOINTS_TWENTYFIVE      25
#define BLOCKPOINTS_FATIGUE         20
#define BLOCKPOINTS_FIFTEEN         15
#define BLOCKPOINTS_TWELVE          12
#define BLOCKPOINTS_TEN             10
#define BLOCKPOINTS_WARNING         7
#define BLOCKPOINTS_FIVE            5
#define BLOCKPOINTS_DANGER          4
#define BLOCKPOINTS_THREE            3
#define BLOCKPOINTS_FAIL            2
#define	BLOCK_POINTS_MIN            1

#define DEFAULT_BLOCK_TIME_MAX_MILLISECONDS 300

#define BOTZIZE_SMALLEST	60
#define BOTZIZE_SMALLER		70
#define BOTZIZE_SMALL		85
#define BOTZIZE_NORMAL		100
#define BOTZIZE_TALL		110
#define BOTZIZE_LARGE		120
#define BOTZIZE_LARGER		125
#define BOTZIZE_MASSIVE		130
...
typedef struct entityState_s {
	...
	int    botclass;//we need to see what it is on the client for a few effects.
	int    nextbotclass;//we need to see what it is on the client for a few effects.
	int    ManualBlockingFlags; //Blockingflag on OK
	int    PlayerEffectFlags;
	int    blockPoints;
	int    blockPointsMax;
