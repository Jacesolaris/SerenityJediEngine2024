...
#define BLASTERMISHAPLEVEL_MAX		       16
#define BLASTERMISHAPLEVEL_FULL            15
#define BLASTERMISHAPLEVEL_FOURTEEN        14
#define BLASTERMISHAPLEVEL_OVERLOAD	       13
#define BLASTERMISHAPLEVEL_TWELVE          12
#define BLASTERMISHAPLEVEL_ELEVEN		   11
#define BLASTERMISHAPLEVEL_HEAVYER	       10
#define BLASTERMISHAPLEVEL_HALF 	       9
#define BLASTERMISHAPLEVEL_HEAVY	       8
#define BLASTERMISHAPLEVEL_MEDIUM	       7
#define BLASTERMISHAPLEVEL_LIGHT	       5
#define BLASTERMISHAPLEVEL_THREE           3
