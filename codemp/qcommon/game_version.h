...
#define VERSION_INTERNAL_BUILD		18

#define VERSION_STRING				"Year-23,Month-03,Day-18,BuildNum-06"
#define VERSION_STRING_DOTTED		"Year-23,Month-03,Day-18,BuildNum-06"
