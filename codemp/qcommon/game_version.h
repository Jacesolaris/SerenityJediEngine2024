...
#define VERSION_INTERNAL_BUILD		23

#define VERSION_STRING				"Year-23,Month-10,Day-23,BuildNum-15"
#define VERSION_STRING_DOTTED		"Year-23,Month-10,Day-23,BuildNum-15" // build date
