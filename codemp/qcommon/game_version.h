...
#define VERSION_INTERNAL_BUILD		21

#define VERSION_STRING				"Year-23,Month-04,Day-21,BuildNum-03"
#define VERSION_STRING_DOTTED		"Year-23,Month-04,Day-21,BuildNum-03"
