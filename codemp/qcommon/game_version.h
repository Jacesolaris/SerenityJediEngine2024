...
#define VERSION_INTERNAL_BUILD		06

#define VERSION_STRING				"Year-23,Month-09,Day-06,BuildNum-04"
#define VERSION_STRING_DOTTED		"Year-23,Month-09,Day-06,BuildNum-04" // build date
