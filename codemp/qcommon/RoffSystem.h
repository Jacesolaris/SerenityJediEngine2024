...
public:
	...
	qboolean Play(int ent_id, int id, qboolean do_translation, qboolean isClient);
	// TODO: implement signal on playback completion.
	static void ListEnts(); // List the entities that are currently roffing
	qboolean PurgeEnt(int ent_id, qboolean isClient); // Purge the specified entity from the entity list by id
