...
using refexport_t = struct refexport_s
{
	...
	int (*G2API_AddSurface)(CGhoul2Info* ghl_info, int surfaceNumber, int polyNumber, float BarycentricI,
	...
	int (*G2API_InitGhoul2Model)(CGhoul2Info_v** ghoul2Ptr, const char* fileName, int model_index, qhandle_t customSkin,
	...
	qboolean(*G2API_SetBoneAnglesMatrix)(CGhoul2Info* ghl_info, const char* boneName, const mdxaBone_t& matrix,
		int flags, const qhandle_t* model_list, int blend_time, int current_time);
	qboolean(*G2API_SetBoneAnglesMatrixIndex)(CGhoul2Info* ghl_info, int index, const mdxaBone_t& matrix, int flags,
		qhandle_t* model_list, int blend_time, int current_time);
	qboolean(*G2API_SetBoneAnim)(CGhoul2Info_v& ghoul2, int model_index, const char* boneName, int start_frame,
		int end_frame, int flags, float animSpeed, int current_time, float setFrame /*= -1*/,
		int blend_time /*= -1*/);
