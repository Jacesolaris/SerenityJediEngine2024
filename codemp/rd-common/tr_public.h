...
using refexport_t = struct refexport_s
{
	...
	int (*MarkFragments)(int numPoints, const vec3_t* points, const vec3_t projection, int maxPoints,
	...
	void (*RemapShader)(const char* oldShader, const char* new_shader_name, const char* offsetTime);
	...
	qboolean(*G2API_AttachEnt)(int* boltInfo, CGhoul2Info_v& ghoul2, int modelIndex, int toBoltIndex, int entNum,
		int toModelNum);
	qboolean(*G2API_AttachG2Model)(CGhoul2Info_v& g2From, int model_from, CGhoul2Info_v& g2To, int toBoltIndex,
		int toModel);
	...
	int (*G2API_CopyGhoul2Instance)(const CGhoul2Info_v& g2_from, CGhoul2Info_v& g2_to, int modelIndex);
	...
	qboolean(*G2API_SetBoneAngles)(CGhoul2Info_v& ghoul2, int modelIndex, const char* boneName, const vec3_t angles, int flags, Eorientations up, Eorientations left, Eorientations forward, qhandle_t* modelList, int blendTime, int acurrentTime);

	qboolean(*G2API_SetBoneAnglesIndex)(CGhoul2Info* ghlInfo, int index, const vec3_t angles, int flags, Eorientations yaw, Eorientations pitch, Eorientations roll, qhandle_t* modelList, int blendTime, int acurrentTime);
	...
	qboolean(*G2API_SetBoneAnim)(CGhoul2Info_v& ghoul2, int modelIndex, const char* boneName, int startFrame, int endFrame, int flags, float animSpeed, int acurrentTime, float setFrame, int blendTime);
	...
	qboolean(*G2API_SetNewOrigin)(CGhoul2Info_v& ghoul2, int boltIndex);
