...
using shader_t = struct shader_s {
	...
	int			lightmapIndex[MAXLIGHTMAPS];	// for a shader to match, both name and lightmapIndex must match  vanilla mp
...
#ifdef _MSC_VER
using shaderCommands_t = __declspec(align(16)) shaderCommands_s;
#else
