...
void CG_SetInitialSnapshot(snapshot_t* snap)
{
	...
	if (cg_entities[snap->ps.client_num].ghoul2 == NULL && trap->G2_HaveWeGhoul2Models(
		cgs.clientinfo[snap->ps.client_num].ghoul2Model))
	{
		trap->G2API_DuplicateGhoul2Instance(cgs.clientinfo[snap->ps.client_num].ghoul2Model,
			&cg_entities[snap->ps.client_num].ghoul2);
		CG_CopyG2WeaponInstance(&cg_entities[snap->ps.client_num], FIRST_WEAPON,
			cg_entities[snap->ps.client_num].ghoul2);
