...
stringID_table_t animTable[MAX_ANIMATIONS + 1] =
{
	...
	ENUM2STRING(MELEE_STANCE_T_MP),
	ENUM2STRING(MELEE_STANCE_LT_MP),
	ENUM2STRING(MELEE_STANCE_RT_MP),
	ENUM2STRING(MELEE_STANCE_BR_MP),
	ENUM2STRING(MELEE_STANCE_BL_MP),
	ENUM2STRING(MELEE_STANCE_B_MP),
	...
	ENUM2STRING(BOTH_SPRINT_MP), //# Full gunners sprint
	ENUM2STRING(BOTH_SPRINT_SABER), //# Full jedi sprint
	ENUM2STRING(BOTH_SPRINT_SABER_MP), //# Full jedi sprint
	...
	ENUM2STRING(BOTH_RUN3_MP), //# Full riflerun
	...
	ENUM2STRING(BOTH_RIFLERELOADB),
	ENUM2STRING(BOTH_RIFLERELOADR),
	ENUM2STRING(BOTH_RIFLERELOADL),
	...
	ENUM2STRING(BOTH_PARRY_WALK_DUAL),
	ENUM2STRING(BOTH_PARRY_WALK_STAFF),
	...
	ENUM2STRING(BOTH_BOLT_BLOCK_BACKHAND_MIDDLE_TOP),
