...
public:
	...
	void Delete() override;
	bool ProcessElse() override;

protected:
	void Init();
};

using LPTokenizerErrorProc = void (*)(const char* errString);
...
public:
	...
	void Delete() override;
	bool NextChar(byte& theByte) override;
	int GetCurLine() override;
	void GetCurFilename(char** theBuff) override;
	long GetRemainingSize() override;
...
public:
	...
	void Delete() override;
	bool IsThisDefinition(void* theDefinition) override;
