...
protected:
	...
	int GetVector(int ent_id, CBlock* block, int& memberNum, vector_t& value);
	int GetFloat(int ent_id, const CBlock* block, int& memberNum, float& value) const;
	int Get(int ent_id, CBlock* block, int& memberNum, char** value);
