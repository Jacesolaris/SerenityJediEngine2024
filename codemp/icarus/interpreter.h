...
using variable_t = struct variable_s
{
...
public:
	...
	static keywordArray_t* GetSymbols() { return reinterpret_cast<keywordArray_t*>(&m_symbolKeywords); }	//Returns the interpreter's symbol table
	static keywordArray_t* GetIDs() { return reinterpret_cast<keywordArray_t*>(&m_IDKeywords); }	//Returns the interpreter's ID table
	static keywordArray_t* GetTypes() { return reinterpret_cast<keywordArray_t*>(&m_typeKeywords); }		//Returns the interpreter's type table
