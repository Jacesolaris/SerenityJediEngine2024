...
int G2API_InitGhoul2Model(CGhoul2Info_v** ghoul2Ptr, const char* fileName, const int modelIndex, const qhandle_t customSkin = NULL_HANDLE, const qhandle_t customShader = NULL_HANDLE, const int modelFlags = 0, const int lodBias = 0);
...
qboolean G2API_SetBoneAnim(CGhoul2Info_v& ghoul2, const int modelIndex, const char* boneName, const int astartFrame, const int aendFrame, const int flags, const float animSpeed, const int acurrentTime, const float asetFrame = -1, const int blendTime = -1);
...
qboolean G2API_SetBoneAnglesMatrix(CGhoul2Info* ghlInfo, const char* boneName, const mdxaBone_t& matrix, const int flags, const qhandle_t* modelList, const int blendTime = 0, const int acurrentTime = 0);
...
void G2API_CopySpecificG2Model(CGhoul2Info_v& g2From, int model_from, CGhoul2Info_v& g2To, int model_to);
