...
qboolean G2_Set_Bone_Anim(const CGhoul2Info* ghlInfo, boneInfo_v& blist, const char* boneName, int startFrame,
	int endFrame, int flags, float animSpeed, int currentTime, float setFrame, int blendTime);
...
qboolean G2_Pause_Bone_Anim(const CGhoul2Info* ghlInfo, boneInfo_v& blist, const char* boneName, int currentTime);
...
qboolean G2_Set_Bone_Anim_Index(boneInfo_v& blist, int index, int startFrame, int endFrame, int flags, float animSpeed,
	int currentTime, float setFrame, int ablend_time, int numFrames);
...
void G2_TraceModels(CGhoul2Info_v& ghoul2, vec3_t rayStart, vec3_t rayEnd, CollisionRecord_t* collRecMap, int entNum,
	int e_g2_trace_type, int useLod, float fRadius, float ssize, float tsize, float theta, int shader,
	SSkinGoreData* gore, qboolean skipIfLODNotMatch);
#else
...
int G2API_InitGhoul2Model(CGhoul2Info_v** ghoul2Ptr, const char* file_name, int modelIndex, const qhandle_t customSkin = NULL_HANDLE, const qhandle_t customShader = NULL_HANDLE, int modelFlags = 0, const int lodBias = 0);
...
qboolean G2API_RemoveGhoul2Model(CGhoul2Info_v** ghlRemove, int modelIndex);
qboolean G2API_RemoveGhoul2Models(CGhoul2Info_v** ghlRemove);
qboolean G2API_SetSurfaceOnOff(CGhoul2Info_v& ghoul2, const char* surfaceName, int flags);
...
qboolean G2API_SetBoneAngles(CGhoul2Info_v& ghoul2, int modelIndex, const char* boneName, const vec3_t angles,
...
void G2API_SetBoltInfo(CGhoul2Info_v& ghoul2, int modelIndex, int bolt_info);
...
qboolean G2API_SetBoneAnglesMatrix(CGhoul2Info* ghlInfo, const char* boneName, const mdxaBone_t& matrix, int flags,
	const qhandle_t* modelList, int blendTime = 0, int currentTime = 0);
...
qboolean G2API_SetBoneAnimIndex(CGhoul2Info* ghlInfo, int index, int astartFrame, int aendFrame, int flags,
	float animSpeed, int acurrent_time, float aset_frame, int blendTime);
