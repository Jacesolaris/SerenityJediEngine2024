...
struct boneInfo_t
{
	...
	boneInfo_t() :
		...
		boneBlendTime(0),
		boneBlendStart(0),
		lastTime(0), newMatrix(), lastTimeUpdated(0), lastContents(0), lastPosition{}, velocityEffector{}, lastAngles{},
		minAngles{},
		maxAngles{},
		currentAngles{},
		anglesOffset{},
		...
		ragIndex(0),
		velocityRoot{},
		ragStartTime(0), firstTime(0),
		firstCollisionTime(0),
		restTime(0),
		RagFlags(0), DependentRagIndexMask(0), originalTrueBoneMatrix(), parentTrueBoneMatrix(),
		parentOriginalTrueBoneMatrix(), originalOrigin{},
		originalAngles{},
		lastShotDir{},
		...
		ragOverrideMatrix(),
		extraMatrix(), extraVec1{},
		extraFloat1(0),
		extraInt1(0), ikPosition{},
		ikSpeed(0), epVelocity{},
		epGravFactor(0),
		solidCount(0),
...
using mdxaBone_v = std::vector<std::pair<int, mdxaBone_t>>;
