...
void GVM_ROFF_NotetrackCallback(int ent_id, const char* notetrack);
...
qboolean GVM_NAV_ClearPathToPoint(int ent_id, vec3_t pmins, vec3_t pmaxs, vec3_t point, int clipmask, int okToHitEnt);
