...
*/
static void G2_RagDollSolve(CGhoul2Info_v& ghoul2_v, int g2_index, float decay, int frameNum, const vec3_t currentOrg, bool LimitAngles, CRagDollUpdateParams* params = NULL);
...
static void G2_RagDoll(CGhoul2Info_v& ghoul2_v, int g2_index, CRagDollUpdateParams* params, int curTime)
{
	...
	if (iters)
	{
		...
		{
			G2_RagDollCurrentPosition(ghoul2_v, g2_index, frameNum, params->angles, dPos, params->scale);
			...
			G2_RagDollSolve(ghoul2_v, g2_index, decay * 2.0f, frameNum, dPos, true, params);
		}
	}
...
void Rag_Trace(trace_t* results, const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end, const int passentity_num, const int contentmask, const EG2_Collision e_g2_trace_type, const int useLod)
{
#ifdef _DEBUG
	...
	else
	{
		...
		//SV_Trace(results, start, mins, maxs, end, passentity_num, contentmask, e_g2_trace_type, useLod);
...
static void G2_IKSolve(CGhoul2Info_v& ghoul2_v, int g2_index, float decay, int frameNum, const vec3_t currentOrg, bool limitAngles)
{
	int i;
