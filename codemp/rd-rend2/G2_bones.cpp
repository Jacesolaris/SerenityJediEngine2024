...
*/
static void G2_RagDollSolve(CGhoul2Info_v& ghoul2_v, int g2_index, float decay, int frame_num, const vec3_t currentOrg, bool LimitAngles, CRagDollUpdateParams* params = NULL);
...
static void G2_RagDollSolve(CGhoul2Info_v& ghoul2_v, int g2_index, float decay, int frame_num, const vec3_t currentOrg, bool limitAngles, CRagDollUpdateParams* params)
{
	int i;
