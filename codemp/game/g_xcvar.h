...
#endif
XCVAR_DEF(g_dismember, "50", NULL, CVAR_ARCHIVE, qtrue)
...
XCVAR_DEF(g_npcspskill, "3", NULL, CVAR_ARCHIVE | CVAR_INTERNAL, qfalse)
...
XCVAR_DEF(g_saberLockFactor, "0", NULL, CVAR_ARCHIVE, qtrue)
...
XCVAR_DEF(m_nerf, "1", NULL, CVAR_INTERNAL | CVAR_SERVERINFO, qtrue)
...
XCVAR_DEF(g_saberLockCinematicCamera, "0", NULL, CVAR_ARCHIVE, qtrue)
