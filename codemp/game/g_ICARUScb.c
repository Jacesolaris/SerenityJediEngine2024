...
int Q3_PlaySound(const int taskID, const int ent_id, const char* name, const char* channel)
{
...
-------------------------
*/
void Q3_Play(const int taskID, const int ent_id, const char* type, const char* name)
{
	gentity_t* ent = &g_entities[ent_id];
...
=============
*/
void Q3_Lerp2Start(const int ent_id, const int taskID, const float duration)
{
	gentity_t* ent = &g_entities[ent_id];

	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_Lerp2Start: invalid ent_id %d\n", ent_id);
		return;
	}
...
=============
*/
void Q3_Lerp2End(const int ent_id, const int taskID, const float duration)
{
	gentity_t* ent = &g_entities[ent_id];

	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_Lerp2End: invalid ent_id %d\n", ent_id);
		return;
	}
...
=============
*/
void Q3_Lerp2Pos(const int taskID, const int ent_id, vec3_t origin, vec3_t angles, float duration)
{
	gentity_t* ent = &g_entities[ent_id];

	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_Lerp2Pos: invalid ent_id %d\n", ent_id);
		return;
	}
...
=============
*/
void Q3_Lerp2Angles(const int taskID, const int ent_id, vec3_t angles, const float duration)
{
	gentity_t* ent = &g_entities[ent_id];
	vec3_t ang;
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_Lerp2Angles: invalid ent_id %d\n", ent_id);
		return;
	}
...
=============
*/
int Q3_GetTag(const int ent_id, const char* name, const int lookup, vec3_t info)
{
...
============
*/
void Q3_Use(const int ent_id, const char* target)
{
	gentity_t* ent = &g_entities[ent_id];

	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_Use: invalid ent_id %d\n", ent_id);
		return;
	}
...
============
*/
void Q3_Kill(const int ent_id, const char* name)
{
	gentity_t* ent = &g_entities[ent_id];
	gentity_t* victim;
...
============
*/
void Q3_Remove(const int ent_id, const char* name)
{
	gentity_t* ent = &g_entities[ent_id];
	gentity_t* victim;
...
============
*/
int Q3_GetFloat(const int ent_id, int type, const char* name, float* value)
{
	const gentity_t* ent = &g_entities[ent_id];
...
============
*/
int Q3_GetVector(const int ent_id, int type, const char* name, vec3_t value)
{
	const gentity_t* ent = &g_entities[ent_id];
	if (!ent)
	{
...
int Q3_GetString(const int ent_id, int type, const char* name, char** value)
{
	const gentity_t* ent = &g_entities[ent_id];
	if (!ent)
	{
...
static void Q3_SetCopyOrigin(const int ent_id, const char* name)
{
	...
	if (found)
	{
		Q3_SetOrigin(ent_id, found->r.currentOrigin);
...
static void Q3_SetVelocity(const int ent_id, const int axis, const float speed)
{
	...
	if (!found)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetVelocity invalid ent_id %d\n", ent_id);
		return;
	}
...
void Q3_Lerp2Origin(const int taskID, const int ent_id, vec3_t origin, const float duration)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_Lerp2Origin: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetOriginOffset(const int ent_id, const int axis, const float offset)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetOriginOffset: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetEnemy(const int ent_id, const char* name)
{
	...
	if (!ent || !ent->client)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetEnemy: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetLeader(const int ent_id, const char* name)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetLeader: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void SetLowerAnim(const int ent_id, const int animID)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "SetLowerAnim: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void SetUpperAnim(const int ent_id, const int animID)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "SetUpperAnim: invalid ent_id %d\n", ent_id);
		return;
	}
...
=============
*/
static qboolean Q3_SetAnimUpper(const int ent_id, const char* anim_name)
{
...
=============
*/
static qboolean Q3_SetAnimLower(const int ent_id, const char* anim_name)
{
...
============
*/
static void Q3_SetAnimHoldTime(const int ent_id, const int int_data, const qboolean lower)
{
	const gentity_t* ent = &g_entities[ent_id];
...
static void Q3_SetRenderCullRadius(int ent_id, float float_data);

static void Q3_SetPlayerTeam(const int ent_id, const char* data)
{
	const gentity_t* ent = &g_entities[ent_id];
...
//==========
static void Q3_SetEnemyTeam(const int ent_id, const char* data)
{
	const gentity_t* ent = &g_entities[ent_id];
...
============
*/
static void Q3_SetHealth(const int ent_id, int data)
{
	gentity_t* ent = &g_entities[ent_id];

	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetHealth: invalid ent_id %d\n", ent_id);
		return;
	}
...
============
*/
static void Q3_SetArmor(const int ent_id, const int data)
{
	const gentity_t* ent = &g_entities[ent_id];

	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetArmor: invalid ent_id %d\n", ent_id);
		return;
	}
...
static qboolean Q3_SetBState(const int ent_id, const char* bs_name)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetBState: invalid ent_id %d\n", ent_id);
		return qtrue;
	}
...
static qboolean Q3_SetTempBState(const int ent_id, const char* bs_name)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetTempBState: invalid ent_id %d\n", ent_id);
		return qtrue;
	}
...
static void Q3_SetDefaultBState(const int ent_id, const char* bs_name)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetDefaultBState: invalid ent_id %d\n", ent_id);
		return;
	}
...
#define SET_NPC(s) gentity_t	*ent = &g_entities[ent_id];\
	if (!ent->NPC) return;\
	ent->NPC->s = data;

#define SET_NPCSTAT(s) gentity_t	*ent = &g_entities[ent_id];\
	if (!ent->NPC) return;\
...
static void Q3_SetDPitch(const int ent_id, float data)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetDPitch: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetDYaw(const int ent_id, const float data)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetDYaw: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetWidth(const int ent_id, const int data)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetWidth: invalid ent_id %d\n", ent_id);
		return;
	}
...
============
*/
void Q3_SetInvisible(const int ent_id, const qboolean invisible)
{
	gentity_t* self = &g_entities[ent_id];

	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetInvisible: invalid ent_id %d\n", ent_id);
		return;
	}
...
============
*/
static void Q3_SetVampire(int ent_id, qboolean vampire)
{
}
...
static void Q3_SetGreetAllies(const int ent_id, const qboolean greet)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetGreetAllies: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetViewTarget(const int ent_id, const char* name)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetViewTarget: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetWatchTarget(const int ent_id, const char* name)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetWatchTarget: invalid ent_id %d\n", ent_id);
		return;
	}
...
============
*/
void Q3_SetViewEntity(int ent_id, const char* name)
{
...
void SetSpawnWeapon(const int weap)
{
	if (weap == WP_NONE)
	{
		//reset SpawnWeapons
...
static void Q3_SetWeapon(const int ent_id, const char* wp_name)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetWeapon: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetWalkSpeed(const int ent_id, const int int_data)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetWalkSpeed: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetRunSpeed(const int ent_id, const int int_data)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetRunSpeed: invalid ent_id %d\n", ent_id);
		return;
	}
...
============
*/
static void Q3_SetYawSpeed(const int ent_id, const float data)
{
...
============
*/
static void Q3_SetAggression(const int ent_id, const int data)
{
...
============
*/
static void Q3_SetAim(const int ent_id, const int data)
{
	SET_NPCSTAT(aim);
}
...
static void Q3_SetFriction(const int ent_id, const int int_data)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetFriction: invalid ent_id %d\n", ent_id);
		return;
	}
...
============
*/
static void Q3_SetGravity(const int ent_id, const float float_data)
{
	const gentity_t* self = &g_entities[ent_id];

	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetGravity: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetWait(const int ent_id, const float float_data)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetWait: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetShotSpacing(const int ent_id, const int data)
{
...
============
*/
static void Q3_SetFollowDist(const int ent_id, const float data)
{
	SET_NPC(followDist);
}
...
============
*/
static void Q3_SetScale(const int ent_id, const float float_data)
{
	gentity_t* self = &g_entities[ent_id];

	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetScale: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetCount(const int ent_id, const char* data)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetCount: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetTargetName(const int ent_id, const char* targetname)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetTargetName: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetTarget(const int ent_id, const char* target)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetTarget: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetTarget2(const int ent_id, const char* target2)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetTarget2: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetRemoveTarget(const int ent_id, const char* target)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetRemoveTarget: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetPainTarget(const int ent_id, const char* targetname)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetPainTarget: invalid ent_id %d\n", ent_id);
		return;
	}
...
============
*/
static void Q3_SetFullName(const int ent_id, const char* fullName)
{
	gentity_t* self = &g_entities[ent_id];

	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetFullName: invalid ent_id %d\n", ent_id);
		return;
	}
...
void SetSpawnForcePower(const int forcePower, const int forceLevel)
{
...
static void Q3_SetForcePowerLevel(const int ent_id, const int forcePower, const int forceLevel)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_ERROR, "Q3_SetForcePowerLevel: invalid ent_id %d\n", ent_id);
		return;
	}
...
void Q3_SetParm(const int ent_id, const int parmNum, const char* parmValue)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetParm: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetCaptureGoal(const int ent_id, const char* name)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetCaptureGoal: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetEvent(const int ent_id, const char* event_name)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetEvent: invalid ent_id %d\n", ent_id);
		return;
	}
...
#define SET_ENT(s) gentity_t	*ent = &g_entities[ent_id];\
	ent->s = data;
...
static void Q3_SetIgnorePain(const int ent_id, const qboolean data)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetIgnorePain: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetIgnoreEnemies(const int ent_id, const qboolean data)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetIgnoreEnemies: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetIgnoreAlerts(const int ent_id, const qboolean data)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetIgnoreAlerts: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetNoTarget(const int ent_id, const qboolean data)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetNoTarget: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetLean(const int ent_id, const int lean)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetLean: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetDontShoot(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetDontShoot: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetDontFire(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetDontFire: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetFireWeapon(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_FireWeapon: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetSafeRemove(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetSafeRemove: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetInactive(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetInactive: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetFuncUsableVisible(const int ent_id, const qboolean visible)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetFuncUsableVisible: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetLockedEnemy(const int ent_id, const qboolean locked)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetLockedEnemy: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetNoMindTrick(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetNoMindTrick: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetCrouched(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetCrouched: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetWalking(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetWalking: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetRunning(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetRunning: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetForcedMarch(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetForcedMarch: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetChaseEnemies(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetChaseEnemies: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetLookForEnemies(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetLookForEnemies: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetFaceMoveDir(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetFaceMoveDir: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetAltFire(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetAltFire: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetDontFlee(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetDontFlee: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetNoResponse(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetNoResponse: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetCombatTalk(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetCombatTalk: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetAlertTalk(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetAlertTalk: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetUseCpNearest(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetUseCpNearest: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetNoForce(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetNoForce: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetNoAcrobatics(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetNoAcrobatics: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetUseSubtitles(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetUseSubtitles: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetNoFallToDeath(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetNoFallToDeath: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetDismemberable(const int ent_id, const qboolean dismemberable)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetDismemberable: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetMoreLight(const int ent_id, const qboolean add)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetMoreLight: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetUndying(const int ent_id, const qboolean undying)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetUndying: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetInvincible(const int ent_id, const qboolean invincible)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetInvincible: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetForceInvincible(const int ent_id, const qboolean forceInv)
{
	...
	if (!self || !self->client)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetForceInvincible: ent_id %d not a client\n", ent_id);
		return;
	}
...
static void Q3_SetNoAvoid(const int ent_id, const qboolean noAvoid)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetNoAvoid: invalid ent_id %d\n", ent_id);
		return;
	}
...
static qboolean Q3_SetSolid(const int ent_id, const qboolean solid)
{
	...
	if (!ent || !ent->inuse)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetSolid: invalid ent_id %d\n", ent_id);
		return qtrue;
	}
...
static void Q3_SetForwardMove(const int ent_id, const int fmoveVal)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetForwardMove: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetRightMove(const int ent_id, const int rmoveVal)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetRightMove: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetLockAngle(const int ent_id, const char* lockAngle)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetLockAngle: invalid ent_id %d\n", ent_id);
		return;
	}
...
============
*/
static void Q3_CameraGroup(const int ent_id, char* camG)
{
	gentity_t* ent = &g_entities[ent_id];
...
============
*/
static void Q3_RemoveRHandModel(int ent_id, char* addModel)
{
...
============
*/
static void Q3_AddRHandModel(int ent_id, char* addModel)
{
...
============
*/
static void Q3_AddLHandModel(int ent_id, char* addModel)
{
...
============
*/
static void Q3_RemoveLHandModel(int ent_id, char* addModel)
{
...
static void Q3_LookTarget(const int ent_id, char* targetName)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_LookTarget: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_Face(const int ent_id, const int expression, float holdtime)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_Face: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetNoImpactDamage(const int ent_id, const qboolean noImp)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetNoImpactDamage: invalid ent_id %d\n", ent_id);
		return;
	}
...
static qboolean Q3_SetBehaviorSet(const int ent_id, const int toSet, const char* scriptname)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetBehaviorSet: invalid ent_id %d\n", ent_id);
		return qfalse;
	}
...
static void Q3_SetDelayScriptTime(const int ent_id, const int delayTime)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetDelayScriptTime: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetPlayerUsable(const int ent_id, const qboolean usable)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetPlayerUsable: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetDisableShaderAnims(const int ent_id, const int disabled)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetDisableShaderAnims: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetShaderAnim(const int ent_id, const int disabled)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetShaderAnim: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetStartFrame(const int ent_id, const int startFrame)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetStartFrame: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetEndFrame(const int ent_id, const int endFrame)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetEndFrame: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetAnimFrame(const int ent_id, const int animFrame)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetAnimFrame: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetLoopAnim(const int ent_id, const qboolean loopAnim)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetLoopAnim: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetShields(const int ent_id, const qboolean shields)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetShields: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetSaberActive(const int ent_id, const qboolean active)
{
	...
	if (!ent || !ent->inuse)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetSaberActive: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetAdjustAreaPortals(const int ent_id, const qboolean adjust)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetAdjustAreaPortals: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetDmgByHeavyWeapOnly(const int ent_id, const qboolean dmg)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetDmgByHeavyWeapOnly: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetShielded(const int ent_id, const qboolean dmg)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetShielded: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetNoGroups(const int ent_id, const qboolean noGroups)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetNoGroups: invalid ent_id %d\n", ent_id);
		return;
	}
...
static void Q3_SetNoKnockback(const int ent_id, const qboolean noKnockback)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetNoKnockback: invalid ent_id %d\n", ent_id);
		return;
	}
...
qboolean Q3_Set(const int taskID, const int ent_id, const char* type_name, const char* data)
{
	gentity_t* ent = &g_entities[ent_id];
	float float_data;
	int int_data;
	...
	case SET_COPY_ORIGIN:
		Q3_SetCopyOrigin(ent_id, (char*)data);
		break;
	...
	case SET_ENEMY:
		Q3_SetEnemy(ent_id, (char*)data);
		break;

	case SET_LEADER:
		Q3_SetLeader(ent_id, (char*)data);
		break;

	case SET_NAVGOAL:
		if (Q3_SetNavGoal(ent_id, (char*)data))
		{
			trap->ICARUS_TaskIDSet((sharedEntity_t*)ent, TID_MOVE_NAV, taskID);
	...
	case SET_ANIM_UPPER:
		if (Q3_SetAnimUpper(ent_id, (char*)data))
		{
	...
	case SET_ANIM_LOWER:
		if (Q3_SetAnimLower(ent_id, (char*)data))
		{
	...
	case SET_PLAYER_TEAM:
		Q3_SetPlayerTeam(ent_id, (char*)data);
		return qfalse;

	case SET_ENEMY_TEAM:
		Q3_SetEnemyTeam(ent_id, (char*)data);
		return qfalse;
	...
	case SET_BEHAVIOR_STATE:
		if (!Q3_SetBState(ent_id, (char*)data))
		{
	...
	case SET_DEFAULT_BSTATE:
		Q3_SetDefaultBState(ent_id, (char*)data);
		break;

	case SET_TEMP_BSTATE:
		if (!Q3_SetTempBState(ent_id, (char*)data))
		{
			trap->ICARUS_TaskIDSet((sharedEntity_t*)ent, TID_BSTATE, taskID);
			return qfalse; //don't complete
		}
	...
	case SET_CAPTURE:
		Q3_SetCaptureGoal(ent_id, (char*)data);
		break;
	...
	case SET_EVENT:
		Q3_SetEvent(ent_id, (char*)data);
		break;

	case SET_VIEWTARGET:
		Q3_SetViewTarget(ent_id, (char*)data);
		trap->ICARUS_TaskIDSet((sharedEntity_t*)ent, TID_ANGLE_FACE, taskID);
		return qfalse;

	case SET_WATCHTARGET:
		Q3_SetWatchTarget(ent_id, (char*)data);
		break;

	case SET_VIEWENTITY:
		Q3_SetViewEntity(ent_id, (char*)data);
		break;

	case SET_LOOPSOUND:
		Q3_SetLoopSound(ent_id, (char*)data);
		break;

	case SET_ICARUS_FREEZE:
	case SET_ICARUS_UNFREEZE:
		Q3_SetICARUSFreeze(ent_id, (char*)data, toSet == SET_ICARUS_FREEZE);
		break;

	case SET_WEAPON:
		Q3_SetWeapon(ent_id, (char*)data);
		break;

	case SET_ITEM:
		Q3_SetItem(ent_id, (char*)data);
		break;
	...
	case SET_TIMESCALE:
		Q3_SetTimeScale(ent_id, (char*)data);
		break;
	...
	case SET_TARGETNAME:
		Q3_SetTargetName(ent_id, (char*)data);
		break;

	case SET_TARGET:
		Q3_SetTarget(ent_id, (char*)data);
		break;

	case SET_TARGET2:
		Q3_SetTarget2(ent_id, (char*)data);
		break;

	case SET_LOCATION:
		if (!Q3_SetLocation(ent_id, (char*)data))
		{
	...
	case SET_PAINTARGET:
		Q3_SetPainTarget(ent_id, (char*)data);
		break;
	...
	case SET_PARM15:
	case SET_PARM16:
		Q3_SetParm(ent_id, toSet - SET_PARM1, (char*)data);
		break;
	...
	case SET_FFDEATHSCRIPT:
	case SET_MINDTRICKSCRIPT:
		if (!Q3_SetBehaviorSet(ent_id, toSet, (char*)data))
	...
	case SET_CAMERA_GROUP:
		Q3_CameraGroup(ent_id, (char*)data);
		break;
	...
	case SET_LOOK_TARGET:
		Q3_LookTarget(ent_id, (char*)data);
		break;

	case SET_ADDRHANDBOLT_MODEL:
		Q3_AddRHandModel(ent_id, (char*)data);
		break;

	case SET_REMOVERHANDBOLT_MODEL:
		Q3_RemoveRHandModel(ent_id, (char*)data);
		break;

	case SET_ADDLHANDBOLT_MODEL:
		Q3_AddLHandModel(ent_id, (char*)data);
		break;

	case SET_REMOVELHANDBOLT_MODEL:
		Q3_RemoveLHandModel(ent_id, (char*)data);
		break;
	...
	case SET_FULLNAME:
		Q3_SetFullName(ent_id, (char*)data);
		break;
	...
	case SET_NO_PVS_CULL:
		Q3_SetBroadcast(ent_id, Q_stricmp("true", (char*)data) == 0);
		break;

	case SET_FORCE_PULL:
		Q3_SetForcePower(ent_id, FP_PULL, Q_stricmp("true", (char*)data) == 0);
		break;

	case SET_FORCE_PROTECT:
		Q3_SetForcePower(ent_id, FP_PROTECT, Q_stricmp("true", (char*)data) == 0);
		break;
	...
	default:
		//trap->ICARUS_SetVar( taskID, ent_id, type_name, data );
...
void ProcessTag(const int ent_id, char* startpoint)
{
	vec3_t data;
	char* s = startpoint;
	...
	*endpoint = '\0';
	...
	Q3_GetTag(ent_id, classname, type, data);
	*startpoint = '\0';
...
void ParseTags(const int ent_id, const char* data)
{
	char* tagstart;
	while ((tagstart = strchr(data, '$')) != NULL)
	{
		ProcessTag(ent_id, tagstart);
	}
}
...
static void Q3_SetRenderCullRadius(const int ent_id, const float float_data)
{
	...
	if (!self)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetRenderCullRadius: invalid ent_id %d\n", ent_id);
		return;
	}
...
void Q3_SetForcePower(const int ent_id, const int forcePower, const qboolean powerOn)
{
	...
	if (!ent)
	{
		G_DebugPrint(WL_WARNING, "Q3_SetForcePower: invalid ent_id %d\n", ent_id);
		return;
	}
	if (!ent->client)
	{
