...
#define NPCAI_LOCKEDENEMY		0x020000000	//keep current enemy until dead
#define NPCAI_CUSTOM_GRAVITY	0x040000000	//Don't use g_gravity, I fly!
...
#define SCF_IGNORE_ENEMIES	0x020000000	//will ignore all enemies.
