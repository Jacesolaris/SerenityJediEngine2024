...
//		G_Damage(trace_ent, NPC, NPC, dir, tr.endpos, damage * 2,DAMAGE_NO_ARMOR | DAMAGE_NO_KNOCKBACK | DAMAGE_NO_HIT_LOC | DAMAGE_IGNORE_TEAM, MOD_LAVA, HL_NONE);
//	}
//	if (tr.fraction < 1.0f)
//	{
