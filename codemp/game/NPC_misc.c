...
Debug_Printf
*/
void Debug_Printf(const vmCvar_t* cv, const int debug_level, char* fmt, ...)
{
	char* color;
	va_list argptr;
	char msg[1024];
...
Debug_NPCPrintf
*/
void Debug_NPCPrintf(const gentity_t* printNPC, const vmCvar_t* cv, const int debugLevel, char* fmt, ...)
{
	int color;
	va_list argptr;
	char msg[1024];
