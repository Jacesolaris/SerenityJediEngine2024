...
using aas_link_t = struct aas_link_s
{
	int entnum;
	int areanum;
...
using bsp_link_t = struct bsp_link_s
{
	int entnum;
	int leafnum;
...
using bsp_entdata_t = struct bsp_entdata_s
{
	vec3_t origin;
	vec3_t angles;
	vec3_t absmins;
...
//entity
using aas_entity_t = struct aas_entity_s
{
	//entity info
	aas_entityinfo_t i;
...
using aas_settings_t = struct aas_settings_s
{
...
constexpr auto CACHETYPE_PORTAL = 0;
constexpr auto CACHETYPE_AREA = 1;

//routing cache
using aas_routingcache_t = struct aas_routingcache_s
{
...
using aas_routingupdate_t = struct aas_routingupdate_s
{
	int cluster;
...
using aas_reversedlink_t = struct aas_reversedlink_s
{
...
using aas_reversedreachability_t = struct aas_reversedreachability_s
{
	int numlinks;
...
using aas_reachabilityareas_t = struct aas_reachabilityareas_s
{
	int firstarea, numareas;
};

using aas_t = struct aas_s
{
