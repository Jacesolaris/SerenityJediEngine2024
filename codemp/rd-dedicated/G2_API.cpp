...
void G2API_CopySpecificG2Model(CGhoul2Info_v& g2From, const int model_from, CGhoul2Info_v& g2To,
	const int model_to)
{
#if 0
...
char* G2API_GetSurfaceName(CGhoul2Info_v& ghoul2, const int modelIndex, const int surfNumber)
{
	...
	if (G2_SetupModelPointers(ghlInfo))
	{
		auto mod = const_cast<model_t*>(ghlInfo->currentModel);
		mdxmSurface_t* surf;
...
qboolean G2API_SkinlessModel(CGhoul2Info_v& ghoul2, const int modelIndex)
{
	...
	{
		const model_t* mod = const_cast<model_t*>(g2->currentModel);
