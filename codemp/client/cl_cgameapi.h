...
void CGVM_GetOrigin(int ent_id, vec3_t out);
void CGVM_GetAngles(int ent_id, vec3_t out);
trajectory_t* CGVM_GetOriginTrajectory(int ent_id);
trajectory_t* CGVM_GetAngleTrajectory(int ent_id);
void CGVM_ROFF_NotetrackCallback(int ent_id, const char* notetrack);
